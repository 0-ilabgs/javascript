...
console.log(userData[0],"is",userData[1], "years old and can be contacted at",userData[2]);
console.log("I love an",nestedFruitBaskets[0][0]);
console.log(nestedFruitBaskets[1][0],"pancakes are great!");
console.log(nestedFruitBaskets[2][1],"juice!");
...
console.log("this is -2 index: ",arr.at(-2));
